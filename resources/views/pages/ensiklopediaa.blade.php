                ...
                <div class="mt-4 text-white">
                    <div class="mb-4">
                        ...
                        <div class="container mt-4">
                            <form action="{{ route('pages.result') }}" method="GET">
                                @csrf
                            ...
                            @else
                                    ...
                                    <a href="{{ route('pages.ensiklopedia') }}" class="text-default btn btn-danger" style="font-weight: bold;">Coba Lagi</a>

                                    @foreach($results as $result)
                                    <div class="row justify-content-center">
                                            <div class="col-md-3 mb-3">
                                                <div class="card">
                                                    <button type="button" class="btn btn-secondary" onclick="closeCard(this)">
                                                        <i class="fas fa-times"></i> Close
                                                    </button>
                                                    <div class="card-body text-center">
                                                        <h2 class="card-title">{{ $result->nama_situs }}</h2>
                                                        <p>ID Situs: {{ $result->id_situs }}</p>
                                                        <img src="{{ asset("storage/{$result->gambar_situs}") }}" alt="{{ $result->nama_situs }}" class="img-thumbnail">
                                                        <p>Alamat Situs: {{ $result->alamat_situs }}</p>
                                                        <a href="{{ route('detail.situs', $result->id_situs) }}" class="btn btn-danger">
                        ...
                        <div class="row row-cols-1 row-cols-md-3 g-4">
                            ...
                            <script>
                                function closeCard(button) {
                                    // Find the closest parent with the class 'col-md-3' and hide it
                                    const cardCol = button.closest('.col-md-3');
                                    if (cardCol) {
