...
@section('content')
    <div class="container mt-4">
        ...
        <form action="{{ route('uploadsitus.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="pemilik" name="pemilik" value="{{ Auth::user()->email }}" readonly>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="keterangan" name="keterangan_situs" rows="5"></textarea>
            </div>                             
